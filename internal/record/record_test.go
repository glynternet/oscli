...
func replayPackets(logger *log.Logger, recorded Entries) []time.Duration {
	...
	logger.Println("finished replaying")
	return replayed
}

func generateMessages(ctx context.Context, log *log.Logger, client *osc2.Client, frequency wave.Frequency, countCh chan<- int) {
